...
mycoco = open('/home/hong/dev_ws/DL_project/mycoco.txt', 'r')
data = mycoco.read()
class_list = data.split('\n')
mycoco.close()
print(class_list)
       
model = YOLO('/home/hong/dev_ws/DL_project/best.pt')
...
from_class = uic.loadUiType("/home/hong/dev_ws/DL_project/myui.ui")[0]
